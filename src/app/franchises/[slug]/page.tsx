...
const investmentBreakdowns: Record<string, InvestmentRow[]> = {
  "payroll-vault": [
    { item: "Initial Franchise Fees", low: "$68,500", high: "$88,500" },
    { item: "Rent", low: "$0", high: "$800" },
    { item: "Rental Improvements", low: "$0", high: "$400" },
    { item: "Deposits", low: "$0", high: "$1,000" },
    { item: "American Payroll Association Training Fee", low: "$0", high: "$1,810" },
    { item: "Training Expenses", low: "$0", high: "$0" },
    { item: "Computer System", low: "$225", high: "$1,225" },
    { item: "Furniture, Fixtures", low: "$150", high: "$650" },
    { item: "Equipment, and Phone Lines", low: "$0", high: "$0" },
    { item: "Technology Startup Fee", low: "$1,500", high: "$1,500" },
    { item: "Insurance and Professional Services", low: "$4,000", high: "$6,000" },
    { item: "Additional Funds - 3 months", low: "$3,000", high: "$10,000" },
